...
channel_refresh_token_key = channel_config['ByteSizeCrypto']['channel_refresh_token_key']
asset_directory = channel_config['ByteSizeCrypto']['asset_directory']
voice = channel_config['ByteSizeCrypto']['voice']
topics = channel_config['ByteSizeCrypto']['topics']
prompt_styles = channel_config['ByteSizeCrypto']['prompt_styles']
guidelines = channel_config['ByteSizeCrypto']['guidelines']
system_message = channel_config['ByteSizeCrypto']['system_message']
video_description = channel_config['ByteSizeCrypto']['video_description']
video_tags = channel_config['ByteSizeCrypto']['video_tags']
